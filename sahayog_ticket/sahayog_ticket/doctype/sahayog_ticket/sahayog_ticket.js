...
frappe.ui.form.on("Sahayog Ticket", {
  dept_name: function (frm) {
    ...
    } else if (frm.doc.dept_name == "Accounts") {
      frm.set_query("ticket_type", function () {
        return {
          filters: {
            department: "Accounts",
    ...
    } else if (frm.doc.dept_name == "Facility") {
      frm.set_query("ticket_type", function () {
        return {
          filters: {
            department: "Facility",
    ...
    } else if (frm.doc.dept_name == "Operations") {
      frm.set_query("ticket_type", function () {
        return {
          filters: {
  ...
  refresh: function (frm) {
    if (!frm.is_new()) {
      ...
      var intro_owner =
        ...
        "</table>" +
        "</div>" +
        "<div style='flex: 2; padding: 5px; margin-top: 0px;'>"; // Adjusted margin-top to 0px
      ...
      var ticket_details =
        ...
        "</tr>" +
        "<tr>" +
        "<td style='border: 1px solid white; width: 20%;'><b>Department:</b></td>" +
        "<td style='border: 1px solid white;'>" +
        ticket_department +
        "</td>" +
        "</tr>" +
