...
def update_tat_age():
    ...
    for ticket in tickets:
        ...
        # Set the total_days and employee_name fields for the ticket
        frappe.db.set_value("Sahayog Ticket", ticket_id, "total_days", total_days)
        frappe.db.set_value("Sahayog Ticket", ticket_id, "employee_name", employee_name)
